# QORE Core PR #466 — DeepSeek Expert R17 — corrected extended dash closure
...
Because Core changed, all earlier semantic reviews are obsolete for certification. This R17 review is the required fresh Expert stage.
